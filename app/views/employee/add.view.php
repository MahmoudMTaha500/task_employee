<div class="row">
    ...
    <h3 class="text-center title-2">Add New Employee</h3>
    </div>
    <hr>
    <?php 
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              ...
              <input  name="name" type="text" required='required' class="form-control"  value="" placeholder="type your place name">
              </div>
          </div>
          <div class="col-6">
            <div class="form-group">
              <label for="cc-payment" class="control-label mb-1">Birth Date:</label>
              <input type="date" class="form-control" required name="birth_date" id="">
              </div> 
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              ...
              <input type="date" class="form-control" required name="hiring_date" id="">
